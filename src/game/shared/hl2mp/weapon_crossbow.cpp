...
void CCrossbowBolt::Spawn( void )
{
	...
	SetSolid( SOLID_BBOX );
	SetGravity( 0.05f );
	SetGravity( sv_gravity.GetFloat() / 2400 ); // takes gravity to pull the bolt down now. 
...
LINK_ENTITY_TO_CLASS( weapon_hl2_crossbow, CWeaponCrossbow );

PRECACHE_WEAPON_REGISTER( weapon_hl2_crossbow );
