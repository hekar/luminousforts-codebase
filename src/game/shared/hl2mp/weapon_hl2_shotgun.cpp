...
//	void WeaponIdle( void );
	...
	virtual SDKWeaponID GetWeaponID( void ) const		{ return SDK_WEAPON_HL2_SHOTGUN; }
...
private:
	CWeaponHL2Shotgun( const CWeaponHL2Shotgun & );
};

IMPLEMENT_NETWORKCLASS_ALIASED( WeaponHL2Shotgun, DT_WeaponHL2Shotgun )

BEGIN_NETWORK_TABLE( CWeaponHL2Shotgun, DT_WeaponHL2Shotgun )
#ifdef CLIENT_DLL
...
#ifdef CLIENT_DLL
BEGIN_PREDICTION_DATA( CWeaponHL2Shotgun )
...
bool CWeaponHL2Shotgun::StartReload( void )
{
	...
	ToSDKPlayer( pOwner )->DoAnimationEvent( PLAYERANIMEVENT_RELOAD );
...
void CWeaponHL2Shotgun::ItemHolsterFrame( void )
{
	...
	float m_flHolsterTime = gpGlobals->curtime;
