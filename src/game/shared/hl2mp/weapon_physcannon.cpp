...
ConVar player_throwforce( "player_throwforce", "900", FCVAR_REPLICATED | FCVAR_CHEAT );

ConVar hl2_normspeed( "hl2_normspeed", "400", FCVAR_REPLICATED | FCVAR_CHEAT );
ConVar hl2_walkspeed( "hl2_walkspeed", "320", FCVAR_REPLICATED | FCVAR_CHEAT );
...
void CPlayerPickupController::Init( CBasePlayer *pPlayer, CBaseEntity *pObject )
{
	...
	CSDKPlayer *pOwner = (CSDKPlayer *)ToBasePlayer( pPlayer );
	if ( pOwner )
	{
...
void CPlayerPickupController::Shutdown( bool bThrown )
{
	...
	if ( m_pPlayer )
	{
		CSDKPlayer *pOwner = (CSDKPlayer *)ToBasePlayer( m_pPlayer );
		if ( pOwner )
		{
...
bool CWeaponPhysCannon::AttachObject( CBaseEntity *pObject, const Vector &vPosition )
{
	...
	CSDKPlayer *pOwner = (CSDKPlayer *)ToBasePlayer( GetOwner() );
