...
//-----------------------------------------------------------------------------
class CWeaponFrag: public CBaseSDKGrenade
{
	DECLARE_CLASS( CWeaponFrag, CBaseSDKGrenade );
public:
...
void DropPrimedFragGrenade( CSDKPlayer *pPlayer, CBaseCombatWeapon *pGrenade )
{
...
void CWeaponFrag::ThrowGrenade( CBasePlayer *pPlayer )
{
	...
	CBaseGrenade *pGrenade = Fraggrenade_Create( vecSrc, vec3_angle, vecThrow, AngularImpulse(600,random->RandomInt(-1200,1200),0), pPlayer, GRENADE_TIMER, false, GetSDKWpnData().m_flDamageForceScale );
