...
//Tony; why all this time has CBaseGrenade been CBaseCombatCharacter? that's soo much overhead..has weapon pointers, all kinds of
//stuff...
#if !defined( CLIENT_DLL )
...
public:
	...
	virtual float GetDamageForceScale() const
	{
		return m_flDamageForceScale;
	}

	virtual void SetDamageForceScale(float flScaleDamageForce)
	{
		m_flDamageForceScale = flScaleDamageForce;
	}
