...
class CClassicGameRules : public CSDKGameRules
{
public:
	DECLARE_CLASS( CClassicGameRules, CSDKGameRules );
	...
	virtual bool GivePlayerClassAttributes( CSDKPlayer *pPlayer );
	virtual void GivePlayerWeapons( CSDKPlayer *pPlayer );
	virtual void GiveBuildPhaseItems( CSDKPlayer *pPlayer );
