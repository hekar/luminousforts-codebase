...
#ifdef CLIENT_DLL
	// Kohan: The following block is commented out to fix an animation problem.
	// See http://developer.valvesoftware.com/wiki/Duplicate_Animation_Events_Fix
/*
...
{
	return BaseClass( idealActivity );
}
#endif
