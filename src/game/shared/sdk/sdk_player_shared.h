...
public:
	...
	void	InitClass( int playerclass );
	...
	bool	IsAllowedToSprint() { return m_bAllowedToSprint; }
	void	SetAllowedToSprint( bool allowed ) { m_bAllowedToSprint = allowed; }
...
private:
	...
	CNetworkVar( bool, m_bAllowedToSprint );
