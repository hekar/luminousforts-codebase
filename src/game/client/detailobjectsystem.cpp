...
ConVar cl_detaildist( "cl_detaildist", "2098", 0, "Distance at which detail props are no longer visible" );
ConVar cl_detailfade( "cl_detailfade", "128", 0, "Distance across which detail props fade in" );
