...
void DrawGradient( Color firstColor, Color secondColor, int x, int y, int wide, int tall, float alpha0, float alpha1, bool horizontal )
{
	surface()->DrawSetColor( firstColor.r(), firstColor.g(), firstColor.b(), 255 );
	surface()->DrawFilledRectFade( x, y, x + wide, y + tall, alpha0, alpha1, horizontal );

	surface()->DrawSetColor( secondColor.r(), secondColor.g(), secondColor.b(), 255 );
