...
#endif
#ifdef MOD_SF132
	else if ( Q_strcmp( PANEL_BUYMENU, szPanelName) == 0 )
	{
		newpanel = new CSF132HudBuy( this );
	}
#endif
#ifdef MOD_HAND_BLOCK_SPAWN
	else if ( Q_strcmp( PANEL_BLOCK, szPanelName) == 0 )
	{
		newpanel = new CBlockSpawn( this, this );
	}
#endif // MOD_HAND_BLOCK_SPAWN
	else
	{
...
#endif
#ifdef MOD_SF132
	AddNewPanel( CreatePanelByName( PANEL_BUYMENU ), "PANEL_BUYMENU" );
#endif
	AddNewPanel( CreatePanelByName( PANEL_BLOCK ), "PANEL_BLOCKSPAWN" );
