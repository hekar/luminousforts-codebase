...
class C_WeaponGravityGun : public C_WeaponSDKBase
{
	DECLARE_CLASS( C_WeaponGravityGun, C_WeaponSDKBase );
public:
	C_WeaponGravityGun() {}
...
IMPLEMENT_CLIENTCLASS_DT( C_WeaponGravityGun, DT_WeaponGravityGun, CWeaponGravityGun )
	RecvPropVector( RECVINFO_NAME(m_targetPosition,m_targetPosition) ),
	RecvPropVector( RECVINFO_NAME(m_worldPosition, m_worldPosition) ),
	RecvPropInt( RECVINFO_NAME(m_active, m_active) ),
	RecvPropInt( RECVINFO_NAME(m_glueTouching, m_glueTouching) ),
	RecvPropInt( RECVINFO_NAME(m_viewModelIndex, m_viewModelIndex) ),
END_RECV_TABLE()
