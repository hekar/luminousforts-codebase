...
#ifndef HL2MP
/*
STUB_WEAPON_CLASS( weapon_ar2, WeaponAR2, C_WeaponSDKBase );
STUB_WEAPON_CLASS( weapon_frag, WeaponFrag, C_WeaponSDKBase );
//STUB_WEAPON_CLASS( weapon_rpg, WeaponRPG, C_BaseHLCombatWeapon );
STUB_WEAPON_CLASS( weapon_hl2_pistol, WeaponHL2Pistol, C_WeaponSDKBase );
STUB_WEAPON_CLASS( weapon_hl2_shotgun, WeaponHL2Shotgun, C_WeaponSDKBase );
STUB_WEAPON_CLASS( weapon_smg1, WeaponSMG1, C_WeaponSDKBase );
STUB_WEAPON_CLASS( weapon_smg2, WeaponSMG2, C_WeaponSDKBase );
STUB_WEAPON_CLASS( weapon_357, Weapon357, C_WeaponSDKBase );
STUB_WEAPON_CLASS( weapon_crossbow, WeaponCrossbow, C_WeaponSDKBase );
//STUB_WEAPON_CLASS( weapon_slam, Weapon_SLAM, C_BaseHLCombatWeapon );
//STUB_WEAPON_CLASS( weapon_crowbar, WeaponCrowbar, C_WeaponSDKBase );
*/
#endif
