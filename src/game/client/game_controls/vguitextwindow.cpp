...
#define TEXTWINDOW_POSX 15
#define TEXTWINDOW_POSY 45

#define TEXTWINDOW_SIZEX w - 32
#define TEXTWINDOW_SIZEY h - 105
...
void CTextWindow::AutoResizeHTMLMessage()
{
}

void CTextWindow::OnSizeChanged( int newWide, int newTall )
{
