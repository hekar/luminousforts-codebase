...
vgui::Panel *CWebWindow::CreateControlByName( const char *controlName )
{
	...
	{
		return new vgui::NewHTML( this, "HTMLMessage" );
	}
...
#endif // #if defined( ENABLE_HTMLWINDOW )
...
#if defined( ENABLE_HTMLWINDOW )
	m_pHTMLMessage = dynamic_cast< vgui::NewHTML * > ( FindChildByName("HTMLMessage") );
