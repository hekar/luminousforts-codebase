...
ProtectedMethod void CPanelListenMain::OnCommand( const char *command )
{
	BaseClass::OnCommand( command );
}

ProtectedMethod void CPanelListenMain::ApplySchemeSettings( vgui::IScheme *pScheme )
{
...
PrivateMethod void CPanelListenMain::DisplayMapsWithPrefix( const char *prefix )
{
...
PrivateMethod void CPanelListenMain::DisplayMaps()
{
	if ( m_MapList->GetItemCount() > 0 )
	{
		ClearMapList();
...
PrivateMethod void CPanelListenMain::ClearMapList()
{
	m_MapList->RemoveAll();
	m_MapList->RemoveAllSections();
}

PrivateMethod void CPanelListenMain::StartServer( const char *mapname )
{
