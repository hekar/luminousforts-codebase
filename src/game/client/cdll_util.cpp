...
{
public:
	CFlagPropgedEntitiesEnum( C_BaseEntity **pList, int listMax, int flagMask );
...
CFlagPropgedEntitiesEnum::CFlagPropgedEntitiesEnum( C_BaseEntity **pList, int listMax, int flagMask )
{
	m_pList = pList;
	m_listMax = listMax;
	m_flagMask = flagMask;
...
bool CFlagPropgedEntitiesEnum::AddToList( C_BaseEntity *pEntity )
{
