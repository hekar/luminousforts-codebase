...
{
	// Get the team color
	const Color& col = GetTeamColor( GetOwnerEntity()->GetTeamNumber(), TEAM_CLR_MED );
...
CBaseGrenade *Fraggrenade_Create( const Vector &position, const QAngle &angles, const Vector &velocity, const AngularImpulse &angVelocity, CBaseEntity *pOwner, float timer, bool combineSpawned, float DamageForceScale )
{
