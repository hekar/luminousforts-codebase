...
//---------------------------------------------------------
int ITEM_HL2_GiveAmmo( CBasePlayer *pPlayer, float flCount, const char *pszAmmoName, bool bSuppressSound = false )
{
...
public:
	...
	{
		if (ITEM_HL2_GiveAmmo( pPlayer, SIZE_AMMO_PISTOL, "Pistol"))
		{
...
public:
	...
	bool MyTouch( CBasePlayer *pPlayer )
	{
		if (ITEM_HL2_GiveAmmo( pPlayer, SIZE_AMMO_PISTOL_LARGE, "Pistol"))
		{
			if ( g_pGameRules->ItemShouldRespawn( this ) == GR_ITEM_RESPAWN_NO )
			{
				UTIL_Remove(this);	
...
public:
	...
	bool MyTouch( CBasePlayer *pPlayer )
	{
		if (ITEM_HL2_GiveAmmo( pPlayer, SIZE_AMMO_SMG1, "SMG1"))
		{
			if ( g_pGameRules->ItemShouldRespawn( this ) == GR_ITEM_RESPAWN_NO )
			{
				UTIL_Remove(this);	
...
public:
	...
	bool MyTouch( CBasePlayer *pPlayer )
	{
		if (ITEM_HL2_GiveAmmo( pPlayer, SIZE_AMMO_SMG1_LARGE, "SMG1"))
		{
			if ( g_pGameRules->ItemShouldRespawn( this ) == GR_ITEM_RESPAWN_NO )
			{
				UTIL_Remove(this);	
...
public:
	...
	bool MyTouch( CBasePlayer *pPlayer )
	{
		if (ITEM_HL2_GiveAmmo( pPlayer, SIZE_AMMO_AR2, "AR2"))
		{
			if ( g_pGameRules->ItemShouldRespawn( this ) == GR_ITEM_RESPAWN_NO )
			{
				UTIL_Remove(this);	
...
public:
	...
	bool MyTouch( CBasePlayer *pPlayer )
	{
		if (ITEM_HL2_GiveAmmo( pPlayer, SIZE_AMMO_AR2_LARGE, "AR2"))
		{
			if ( g_pGameRules->ItemShouldRespawn( this ) == GR_ITEM_RESPAWN_NO )
			{
				UTIL_Remove(this);	
...
public:
	...
	bool MyTouch( CBasePlayer *pPlayer )
	{
		if (ITEM_HL2_GiveAmmo( pPlayer, SIZE_AMMO_357, "357"))
		{
			if ( g_pGameRules->ItemShouldRespawn( this ) == GR_ITEM_RESPAWN_NO )
			{
				UTIL_Remove(this);	
...
public:
	...
	bool MyTouch( CBasePlayer *pPlayer )
	{
		if (ITEM_HL2_GiveAmmo( pPlayer, SIZE_AMMO_357_LARGE, "357"))
		{
			if ( g_pGameRules->ItemShouldRespawn( this ) == GR_ITEM_RESPAWN_NO )
			{
				UTIL_Remove(this);	
...
public:
	...
	bool MyTouch( CBasePlayer *pPlayer )
	{
		if (ITEM_HL2_GiveAmmo( pPlayer, SIZE_AMMO_CROSSBOW, "XBowBolt" ))
		{
			if ( g_pGameRules->ItemShouldRespawn( this ) == GR_ITEM_RESPAWN_NO )
			{
				UTIL_Remove(this);	
...
public:
	...
	bool MyTouch( CBasePlayer *pPlayer )
	{
		if (ITEM_HL2_GiveAmmo( pPlayer, 1, "FlareRound"))
		{
			if ( g_pGameRules->ItemShouldRespawn( this ) == GR_ITEM_RESPAWN_NO )
			{
				UTIL_Remove(this);	
...
public:
	...
	bool MyTouch( CBasePlayer *pPlayer )
	{
		if (ITEM_HL2_GiveAmmo( pPlayer, SIZE_BOX_FLARE_ROUNDS, "FlareRound"))
		{
			if ( g_pGameRules->ItemShouldRespawn( this ) == GR_ITEM_RESPAWN_NO )
			{
				UTIL_Remove(this);	
...
public:
	...
	bool MyTouch( CBasePlayer *pPlayer )
	{
		if (ITEM_HL2_GiveAmmo( pPlayer, SIZE_AMMO_RPG_ROUND, "RPG_Round"))
		{
			if ( g_pGameRules->ItemShouldRespawn( this ) == GR_ITEM_RESPAWN_NO )
			{
				UTIL_Remove(this);	
...
public:
	...
	bool MyTouch( CBasePlayer *pPlayer )
	{
		if (ITEM_HL2_GiveAmmo( pPlayer, SIZE_AMMO_SMG1_GRENADE, "SMG1_Grenade"))
		{
			if ( g_pGameRules->ItemShouldRespawn( this ) == GR_ITEM_RESPAWN_NO )
			{
				UTIL_Remove(this);	
...
public:
	...
	bool MyTouch( CBasePlayer *pPlayer )
	{
		if (ITEM_HL2_GiveAmmo( pPlayer, SIZE_BOX_SNIPER_ROUNDS, "SniperRound"))
		{
			if ( g_pGameRules->ItemShouldRespawn( this ) == GR_ITEM_RESPAWN_NO )
			{
				UTIL_Remove(this);	
...
public:
	...
	bool MyTouch( CBasePlayer *pPlayer )
	{
		if (ITEM_HL2_GiveAmmo( pPlayer, SIZE_AMMO_BUCKSHOT, "Buckshot"))
		{
			if ( g_pGameRules->ItemShouldRespawn( this ) == GR_ITEM_RESPAWN_NO )
			{
				UTIL_Remove(this);	
...
public:
	...
	bool MyTouch( CBasePlayer *pPlayer )
	{
		if (ITEM_HL2_GiveAmmo( pPlayer, SIZE_AMMO_AR2_ALTFIRE, "AR2AltFire" ) )
		{
			if ( g_pGameRules->ItemShouldRespawn( this ) == GR_ITEM_RESPAWN_NO )
			{
				UTIL_Remove(this);	
...
class CItem_HL2_AmmoCrate : public CBaseAnimating
{
public:
	DECLARE_CLASS( CItem_HL2_AmmoCrate, CBaseAnimating );
...
#ifdef MOD_SF132
LINK_ENTITY_TO_CLASS( item_ammo_crate, CItem_HL2_AmmoCrate );
#endif

BEGIN_DATADESC( CItem_HL2_AmmoCrate )
...
// Models names
const char *CItem_HL2_AmmoCrate::m_lpzModelNames[NUM_AMMO_CRATE_TYPES] =
{
...
// Ammo type names
const char *CItem_HL2_AmmoCrate::m_lpzAmmoNames[NUM_AMMO_CRATE_TYPES] =
{
	"Pistol",		
	"SMG1",			
	"AR2",			
...
int CItem_HL2_AmmoCrate::m_nAmmoAmounts[NUM_AMMO_CRATE_TYPES] =
{
	300,	// Pistol
	300,	// SMG1
	300,	// AR2
...
const char *CItem_HL2_AmmoCrate::m_pGiveWeapon[NUM_AMMO_CRATE_TYPES] =
{
	NULL,	// Pistol
	NULL,	// SMG1
	NULL,	// AR2
...
// Purpose: 
//-----------------------------------------------------------------------------
void CItem_HL2_AmmoCrate::Spawn( void )
{
	Precache();
...
// Purpose:
//------------------------------------------------------------------------------
bool CItem_HL2_AmmoCrate::CreateVPhysics( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CItem_HL2_AmmoCrate::Precache( void )
{
	SetupCrate();
...
// Purpose: 
//-----------------------------------------------------------------------------
void CItem_HL2_AmmoCrate::SetupCrate( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CItem_HL2_AmmoCrate::OnRestore( void )
{
	BaseClass::OnRestore();
...
//			value - 
//-----------------------------------------------------------------------------
void CItem_HL2_AmmoCrate::Use( CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType, float value )
{
	...
	if ( GetSequence() != iSequence )
	{
		...
		SetThink( &CItem_HL2_AmmoCrate::CrateThink );
...
//-----------------------------------------------------------------------------
int CItem_HL2_AmmoCrate::OnTakeDamage( const CTakeDamageInfo &info )
{
...
// Input  : *pEvent - 
//-----------------------------------------------------------------------------
void CItem_HL2_AmmoCrate::HandleAnimEvent( animevent_t *pEvent )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CItem_HL2_AmmoCrate::CrateThink( void )
{
	StudioFrameAdvance();
...
// Input  : &data - 
//-----------------------------------------------------------------------------
void CItem_HL2_AmmoCrate::InputKill( inputdata_t &data )
{
	UTIL_Remove( this );
}
