...
//-----------------------------------------------------------------------------
// class CFlagPropgedEntitiesEnum
//-----------------------------------------------------------------------------
// enumerate entities that match a set of edict flags into a static array
class CFlagPropgedEntitiesEnum : public IPartitionEnumerator
{
public:
	CFlagPropgedEntitiesEnum( CBaseEntity **pList, int listMax, int flagMask );
...
int			UTIL_EntitiesInBox( const Vector &mins, const Vector &maxs, CFlagPropgedEntitiesEnum *pEnum  );
int			UTIL_EntitiesAlongRay( const Ray_t &ray, CFlagPropgedEntitiesEnum *pEnum  );
int			UTIL_EntitiesInSphere( const Vector &center, float radius, CFlagPropgedEntitiesEnum *pEnum  );

inline int UTIL_EntitiesInBox( CBaseEntity **pList, int listMax, const Vector &mins, const Vector &maxs, int flagMask )
{
	CFlagPropgedEntitiesEnum boxEnum( pList, listMax, flagMask );
...
{
	CFlagPropgedEntitiesEnum rayEnum( pList, listMax, flagMask );
...
{
	CFlagPropgedEntitiesEnum sphereEnum( pList, listMax, flagMask );
