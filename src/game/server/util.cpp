...
CFlagPropgedEntitiesEnum::CFlagPropgedEntitiesEnum( CBaseEntity **pList, int listMax, int flagMask )
{
	m_pList = pList;
	m_listMax = listMax;
	m_flagMask = flagMask;
...
bool CFlagPropgedEntitiesEnum::AddToList( CBaseEntity *pEntity )
{
...
IterationRetval_t CFlagPropgedEntitiesEnum::EnumElement( IHandleEntity *pHandleEntity )
{
