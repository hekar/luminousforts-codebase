...
enum Collision_Group_t
{
	...
	COLLISION_GROUP_BLOCKING,
	COLLISION_GROUP_FLAG,			// The LuminousForts Rollermine Flag
	COLLISION_GROUP_BLOCKBASE,		// LuminousForts block not held
	COLLISION_GROUP_BLOCKHELD,		// LuminousForts block held
